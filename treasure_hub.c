...
void SIGUSR1_handler()
{
    ...
    if(line[0] && strcmp(line[0], "list hunts")==0)
    {
        list_hunts_handler();
    }
    else if(line[0] && line[1] && strcmp(line[0], "list treasures")==0)
    {
        list_treasures_handler(line[1]);
    }
    else if(line[0] && line[1] && line[2] && strcmp(line[0], "view treasure")==0)
    {
